  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        "3d-destructive": "bg-destructive text-destructive-foreground border-2 border-destructive/50 font-semibold hover:translate-y-[-4px] active:translate-y-[-2px] transition-all duration-150 shadow-[0_8px_0_color-mix(in_oklab,hsl(var(--destructive)),black_25%),0_12px_20px_color-mix(in_oklab,hsl(var(--destructive)),black_50%),inset_0_1px_0_hsl(var(--destructive)/0.3)]",
      },
      size: {
